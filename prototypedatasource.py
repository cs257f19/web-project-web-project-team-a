...
#set query variables to null
#rename functions getCoursebByNumber
#edit comments
#args and kwargs
class CourseQuery:
	'''
	...
	def getCourseByName(self):
		'''
			...
			RETURN:
				a list of course objects that contain name
	...
	def masterQuery(self):
		'''
		Takes checks all query parameters and creates a query compiled of the intersects of all the queries
